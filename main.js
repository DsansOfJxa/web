...
const Benson = document.getElementById("Benson")
const Rayman = document.getElementById("Rayman")
...
const B_Audio = document.getElementById("Benson_Audio")
const R_Audio = document.getElementById("Rayman_Audio")
...
B.addEventListener("click", () => {
  if (Benson.style.display === "none" ||  Benson.style.display === "") {

    N_F()
    Benson.style.display = "Block"


    document.body.style.backgroundImage = "url(img_fondos/Benson.jpeg)"
    F_F()
...
R.addEventListener("click", () => {
  if (Rayman.style.display === "none" ||  Rayman.style.display === "") {

    N_F()
    Rayman.style.display = "Block"


    document.body.style.backgroundImage = "url(img_fondos/Rayman.jpeg)"
    F_F()
